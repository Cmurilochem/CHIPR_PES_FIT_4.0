...
unset title
set xrange [2.5:4.2]
set yrange [-0.17:-0.09]
set format y '%.2f'
set xtics 2.5,0.2,4.2 offset 0,0.5
set xtics font "Helvetica, 10"
set ytics -0.2,0.05,-0.15 offset 0.5,0
...
plot "plot_pot.res" u 1:2 t '' smooth csplines lt 1 lw 3 lc rgb "black",\
"plot_nodes.res" u 3:5 t '' w p pt 7 ps 1.0 lc 7,\
"plot_abinitio.res" u 1:2 t '' w p pt 6 ps 1.0 lc 1
