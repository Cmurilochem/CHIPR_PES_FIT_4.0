...
set label "{/Helvetica-Bold=20 BASIS SET}" at graph 0.4,0.4
...
"plot_basis_abinitio.res" index 2 u 1:2 w p pt 7 lc rgb "dark-gray" t "ab initio points Y3",\
"plot_basis.res" index 2 u 1:2 smooth csplines lt 1 lw 5 lc rgb "magenta" t "fitted curve for coordinate Y3",\
